...
public class SearchBean{
    ...
    public ArrayList<Article> getArticles(String search, String section, String subsection, String author, String tagSub, String tagOrg, String tagPer, String tagLoc) throws IOException {
    	...
    	File f = new File("./Ontology/populated.owl");
		...
		String queryString =
			...
			"PREFIX on: <http://www.polytech_semantic_web.org/fahim_tarik/ontologies/2019/05/semantic#> " +
    ...
    public ArrayList<Article> getRecommendation() throws IOException {
    	...
    	BufferedReader br = new BufferedReader(new FileReader("./src/main/java/recommendation.txt"));
    	section = br.readLine();
    	// No Sections
		if (section == null) {
    ...
    public void addToHistory(String section) {
    	try {
		    String filename= "./src/main/java/recommendation.txt";
